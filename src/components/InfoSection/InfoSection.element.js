...
`;
//background should be 2C2331 but doesn't work as well. ask instructor if darker/lighter shades are allowed 101522
...
color: ${({lightTopLine}) => (lightTopLine ? '#1694cf' : '#509ea7')};
font-size: 18px;
line-height: 16px;
